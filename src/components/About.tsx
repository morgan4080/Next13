            ...
            <Container className="relative">
                <div className="px-4 py-6 sm:pb-48 sm:px-6 lg:px-0">
                    <div>
                        ...
                        <p onMouseEnter={hovered} onMouseLeave={hoveredOut} className={classNames(sulphur_point_400.className, "mt-4 font-display text-xl tracking-tight dark:text-slate-300")}>
                            How it all began.
                        </p>
                        <p onMouseEnter={hovered} onMouseLeave={hoveredOut} className="text-lg my-2 text-gray-600 dark:text-gray-400 leading-relaxed pt-12">
